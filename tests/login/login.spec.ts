...
test.describe('Login Tests', () => {
  ...
  test.only('Existing Users should successfully log in with valid credentials', async ({ page }) => {
  ...
  test.only('Should display valid error message for invalid mobile number', async ({ page }) => {
